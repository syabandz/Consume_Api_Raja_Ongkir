...
<head>
	<meta charset="utf-8">
	<title>Cosume API Raja Ongkir</title>
	...
	<div class="container">
		<div class="row">
			...
			<footer>
				<div class="row">
					<div class="col-md-4">
						<p class="text-center">Copyright © 2019 <a href="#">Syabandz.Blogspot.Com</a></p>
					</div>
				</div>
			</footer>
		</div>
...
$(document).ready(function(){
	$('#provinsi').change(function(){
		...
		$.ajax({
			type : 'GET',
			url : 'http://localhost/belajar/Api/Consume_Api_Raja_Ongkir/cek_kabupaten.php',
			data :  'prov_id=' + prov,
	...
	$("#cek").click(function(){
		...
		$.ajax({
			type : 'POST',
			url : 'http://localhost/belajar/Api/Consume_Api_Raja_Ongkir/cek_ongkir.php',
